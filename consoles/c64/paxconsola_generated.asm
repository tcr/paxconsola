...
; snake_world.fth:208:3 in `draw-apple`
...
; snake_world.fth:208:11 in `draw-apple`
...
; snake_world.fth:208:13 in `draw-apple`
...
; snake_world.fth:208:21 in `draw-apple`
...
; snake_world.fth:208:23 in `draw-apple`
@OPCODE_5:   ; [c64_ir] Call("draw-apple-tile")
        jsr PAX_FN_draw2Dapple2Dtile

@target_1:

; snake_world.fth:208:39 in `draw-apple`
...
; snake_world.fth:8:10 in `random`
...
; snake_world.fth:8:26 in `random`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:8:28 in `random`
...
; snake_world.fth:8:32 in `random`
@OPCODE_4:   ; [c64_ir] Call("and")
        jsr PAX_FN_and

@target_1:

; snake_world.fth:8:36 in `random`
@OPCODE_6:   ; [c64_ir] Call("swap")
        jsr PAX_FN_swap

@target_2:

; snake_world.fth:8:41 in `random`
@OPCODE_8:   ; [c64_ir] Call("%")
        jsr PAX_FN_25

@target_3:

; snake_world.fth:8:43 in `random`
@OPCODE_10:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:42:3 in `snake-x`
@OPCODE_1:   ; [c64_ir] Call("cells")
        jsr PAX_FN_cells

@target_1:

; snake_world.fth:42:9 in `snake-x`
...
; snake_world.fth:42:22 in `snake-x`
@OPCODE_4:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:42:24 in `snake-x`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:45:3 in `snake-y`
@OPCODE_1:   ; [c64_ir] Call("cells")
        jsr PAX_FN_cells

@target_1:

; snake_world.fth:45:9 in `snake-y`
...
; snake_world.fth:45:22 in `snake-y`
@OPCODE_4:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:45:24 in `snake-y`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:48:34 in `convert-x-y`
...
; snake_world.fth:48:37 in `convert-x-y`
@OPCODE_2:   ; [c64_ir] Call("*")
        jsr replace_PAX_FN_2A

@target_1:

; snake_world.fth:48:39 in `convert-x-y`
@OPCODE_4:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:48:41 in `convert-x-y`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:49:34 in `draw-index`
...
; snake_world.fth:49:43 in `draw-index`
@OPCODE_2:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:49:45 in `draw-index`
...
; snake_world.fth:49:48 in `draw-index`
@OPCODE_4:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:51:26 in `draw-white`
...
; snake_world.fth:51:38 in `draw-white`
@OPCODE_2:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_1:

; snake_world.fth:51:42 in `draw-white`
@OPCODE_4:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_2:

; snake_world.fth:51:46 in `draw-white`
@OPCODE_6:   ; [c64_ir] Call("draw")
        jsr PAX_FN_draw

@target_3:

; snake_world.fth:51:51 in `draw-white`
@OPCODE_8:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:53:31 in `draw-snake-tile`
...
; snake_world.fth:53:36 in `draw-snake-tile`
@OPCODE_2:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_1:

; snake_world.fth:53:40 in `draw-snake-tile`
@OPCODE_4:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_2:

; snake_world.fth:53:44 in `draw-snake-tile`
@OPCODE_6:   ; [c64_ir] Call("draw")
        jsr PAX_FN_draw

@target_3:

; snake_world.fth:53:49 in `draw-snake-tile`
@OPCODE_8:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:54:31 in `draw-apple-tile`
...
; snake_world.fth:54:36 in `draw-apple-tile`
@OPCODE_2:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_1:

; snake_world.fth:54:40 in `draw-apple-tile`
@OPCODE_4:   ; [c64_ir] Call("rot")
        jsr PAX_FN_rot

@target_2:

; snake_world.fth:54:44 in `draw-apple-tile`
@OPCODE_6:   ; [c64_ir] Call("draw")
        jsr PAX_FN_draw

@target_3:

; snake_world.fth:54:49 in `draw-apple-tile`
@OPCODE_8:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:57:5 in `draw-background`
...
; snake_world.fth:58:5 in `draw-background`
...
; snake_world.fth:58:12 in `draw-background`
@OPCODE_3:   ; [c64_ir] PushLiteral(0)
    inx
    inx
    lda #0
...
; snake_world.fth:58:14 in `draw-background`
...
; snake_world.fth:59:9 in `draw-background`
...
; snake_world.fth:59:15 in `draw-background`
...
; snake_world.fth:59:17 in `draw-background`
...
; snake_world.fth:60:13 in `draw-background`
...
; snake_world.fth:60:25 in `draw-background`
@OPCODE_15:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_3:

; snake_world.fth:60:30 in `draw-background`
@OPCODE_17:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_4:

; snake_world.fth:60:32 in `draw-background`
...
; snake_world.fth:60:34 in `draw-background`
@OPCODE_20:   ; [c64_ir] Call("draw-index")
        jsr PAX_FN_draw2Dindex

@target_5:

; snake_world.fth:61:9 in `draw-background`
...
; snake_world.fth:62:9 in `draw-background`
...
; snake_world.fth:62:15 in `draw-background`
...
; snake_world.fth:63:4 in `draw-background`
...
; snake_world.fth:64:4 in `draw-background`
@OPCODE_40:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:65:4 in `draw-background`
...
; snake_world.fth:69:11 in `draw-walls`
@OPCODE_2:   ; [c64_ir] PushLiteral(25)
    inx
    inx
    lda #25
...
; snake_world.fth:69:22 in `draw-walls`
...
; snake_world.fth:70:11 in `draw-walls`
@OPCODE_9:   ; [c64_ir] PushLiteral(0)
    inx
    inx
    lda #0
...
; snake_world.fth:70:13 in `draw-walls`
@OPCODE_10:   ; [c64_ir] AltPush
    dex
    dex
    lda $03,x
...
; snake_world.fth:71:14 in `draw-walls`
@OPCODE_15:   ; [c64_ir] Call("over")
        jsr PAX_FN_over
...
; snake_world.fth:71:21 in `draw-walls`
@OPCODE_19:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:71:23 in `draw-walls`
@OPCODE_20:   ; [c64_ir] Call("draw-index")
        jsr PAX_FN_draw2Dindex
...
; snake_world.fth:76:11 in `draw-walls`
...
; snake_world.fth:76:13 in `draw-walls`
...
; snake_world.fth:77:9 in `draw-walls`
...
; snake_world.fth:77:14 in `draw-walls`
@OPCODE_38:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_10:

; snake_world.fth:77:16 in `draw-walls`
...
; snake_world.fth:81:11 in `draw-walls`
...
; snake_world.fth:81:13 in `draw-walls`
...
; snake_world.fth:82:12 in `draw-walls`
...
; snake_world.fth:82:14 in `draw-walls`
...
; snake_world.fth:83:9 in `draw-walls`
...
; snake_world.fth:83:14 in `draw-walls`
@OPCODE_61:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_16:

; snake_world.fth:83:19 in `draw-walls`
@OPCODE_63:   ; [c64_ir] Call("draw-index")
        jsr PAX_FN_draw2Dindex

@target_17:

; snake_world.fth:84:9 in `draw-walls`
...
; snake_world.fth:84:15 in `draw-walls`
...
; snake_world.fth:85:5 in `draw-walls`
...
; snake_world.fth:86:5 in `draw-walls`
@OPCODE_75:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:89:5 in `draw-walls`
...
; snake_world.fth:90:5 in `draw-walls`
...
; snake_world.fth:90:12 in `draw-walls`
...
; snake_world.fth:90:14 in `draw-walls`
...
; snake_world.fth:91:9 in `draw-walls`
...
; snake_world.fth:91:14 in `draw-walls`
@OPCODE_84:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_21:

; snake_world.fth:91:19 in `draw-walls`
@OPCODE_86:   ; [c64_ir] Call("draw-index")
        jsr PAX_FN_draw2Dindex

@target_22:

; snake_world.fth:92:9 in `draw-walls`
...
; snake_world.fth:92:15 in `draw-walls`
...
; snake_world.fth:93:5 in `draw-walls`
...
; snake_world.fth:94:5 in `draw-walls`
@OPCODE_98:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:95:5 in `draw-walls`
...
; snake_world.fth:98:3 in `initialize-snake`
...
; snake_world.fth:98:5 in `initialize-snake`
...
; snake_world.fth:98:12 in `initialize-snake`
...
; snake_world.fth:99:3 in `initialize-snake`
...
; snake_world.fth:99:10 in `initialize-snake`
...
; snake_world.fth:99:12 in `initialize-snake`
@OPCODE_6:   ; [c64_ir] PushLiteral(1)
    inx
    inx
    lda #1
...
; snake_world.fth:99:14 in `initialize-snake`
@OPCODE_7:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:99:16 in `initialize-snake`
...
; snake_world.fth:99:18 in `initialize-snake`
@OPCODE_9:   ; [c64_ir] AltPush
    dex
    dex
    lda $03,x
...
; snake_world.fth:100:5 in `initialize-snake`
...
; snake_world.fth:100:7 in `initialize-snake`
@OPCODE_14:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_2:

; snake_world.fth:100:9 in `initialize-snake`
@OPCODE_16:   ; [c64_ir] Call("-")
    ; http://www.obelisk.me.uk/6502/algorithms.html
    dex
    dex
...
; snake_world.fth:100:11 in `initialize-snake`
@OPCODE_18:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_4:

; snake_world.fth:100:13 in `initialize-snake`
@OPCODE_20:   ; [c64_ir] Call("snake-x")
        jsr PAX_FN_snake2Dx

@target_5:

; snake_world.fth:100:21 in `initialize-snake`
...
; snake_world.fth:101:5 in `initialize-snake`
...
; snake_world.fth:101:7 in `initialize-snake`
@OPCODE_24:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_6:

; snake_world.fth:101:9 in `initialize-snake`
@OPCODE_26:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_7:

; snake_world.fth:101:17 in `initialize-snake`
...
; snake_world.fth:102:3 in `initialize-snake`
...
; snake_world.fth:103:3 in `initialize-snake`
...
; snake_world.fth:103:9 in `initialize-snake`
...
; snake_world.fth:103:19 in `initialize-snake`
...
; snake_world.fth:103:21 in `initialize-snake`
...
; snake_world.fth:105:22 in `set-apple-position`
@OPCODE_1:   ; [c64_ir] PushLiteral(-26664)
    inx
    inx
    lda #216
...
; snake_world.fth:105:30 in `set-apple-position`
...
; snake_world.fth:105:32 in `set-apple-position`
@OPCODE_3:   ; [c64_ir] PushLiteral(-26662)
    inx
    inx
    lda #218
...
; snake_world.fth:105:40 in `set-apple-position`
...
; snake_world.fth:105:42 in `set-apple-position`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:107:21 in `initialize-apple`
...
; snake_world.fth:107:23 in `initialize-apple`
...
; snake_world.fth:107:26 in `initialize-apple`
@OPCODE_3:   ; [c64_ir] Call("set-apple-position")
        jsr PAX_FN_set2Dapple2Dposition

@target_1:

; snake_world.fth:107:45 in `initialize-apple`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:110:3 in `draw-full-snake`
...
; snake_world.fth:110:10 in `draw-full-snake`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:110:12 in `draw-full-snake`
@OPCODE_3:   ; [c64_ir] PushLiteral(0)
    inx
    inx
    lda #0
...
; snake_world.fth:110:14 in `draw-full-snake`
@OPCODE_4:   ; [c64_ir] AltPush
    dex
    dex
    lda $03,x
...
; snake_world.fth:111:5 in `draw-full-snake`
@OPCODE_8:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_2:

; snake_world.fth:111:7 in `draw-full-snake`
@OPCODE_10:   ; [c64_ir] Call("snake-x")
        jsr PAX_FN_snake2Dx

@target_3:

; snake_world.fth:111:15 in `draw-full-snake`
...
; snake_world.fth:111:17 in `draw-full-snake`
@OPCODE_13:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_4:

; snake_world.fth:111:19 in `draw-full-snake`
@OPCODE_15:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_5:

; snake_world.fth:111:27 in `draw-full-snake`
...
; snake_world.fth:111:29 in `draw-full-snake`
@OPCODE_18:   ; [c64_ir] Call("draw-snake-tile")
        jsr PAX_FN_draw2Dsnake2Dtile

@target_6:

; snake_world.fth:112:3 in `draw-full-snake`
...
; snake_world.fth:113:3 in `draw-full-snake`
...
; snake_world.fth:126:12 in `move-up`
@OPCODE_1:   ; [c64_ir] PushLiteral(-1)
    inx
    inx
    lda #255
...
; snake_world.fth:126:15 in `move-up`
...
; snake_world.fth:126:28 in `move-up`
@OPCODE_3:   ; [c64_ir] Call("+!")
        jsr PAX_FN_2B21

@target_1:

; snake_world.fth:126:31 in `move-up`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:127:14 in `move-left`
@OPCODE_1:   ; [c64_ir] PushLiteral(-1)
    inx
    inx
    lda #255
...
; snake_world.fth:127:17 in `move-left`
...
; snake_world.fth:127:30 in `move-left`
@OPCODE_3:   ; [c64_ir] Call("+!")
        jsr PAX_FN_2B21

@target_1:

; snake_world.fth:127:33 in `move-left`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:128:14 in `move-down`
@OPCODE_1:   ; [c64_ir] PushLiteral(1)
    inx
    inx
    lda #1
...
; snake_world.fth:128:16 in `move-down`
@OPCODE_2:   ; [c64_ir] PushLiteral(-27666)
    inx
    inx
    lda #238
...
; snake_world.fth:128:29 in `move-down`
@OPCODE_3:   ; [c64_ir] Call("+!")
        jsr PAX_FN_2B21

@target_1:

; snake_world.fth:128:32 in `move-down`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:129:15 in `move-right`
@OPCODE_1:   ; [c64_ir] PushLiteral(1)
    inx
    inx
    lda #1
...
; snake_world.fth:129:17 in `move-right`
@OPCODE_2:   ; [c64_ir] PushLiteral(-28668)
    inx
    inx
    lda #4
...
; snake_world.fth:129:30 in `move-right`
@OPCODE_3:   ; [c64_ir] Call("+!")
        jsr PAX_FN_2B21

@target_1:

; snake_world.fth:129:33 in `move-right`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:131:20 in `move-snake-head`
...
; snake_world.fth:131:30 in `move-snake-head`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:132:3 in `move-snake-head`
...
; snake_world.fth:132:8 in `move-snake-head`
@OPCODE_4:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_1:

; snake_world.fth:132:14 in `move-snake-head`
@OPCODE_6:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:132:16 in `move-snake-head`
...
; snake_world.fth:132:19 in `move-snake-head`
@OPCODE_10:   ; [c64_ir] Call("move-left")
        jsr PAX_FN_move2Dleft

@target_4:

; snake_world.fth:132:29 in `move-snake-head`
@OPCODE_12:   ; [c64_ir] JumpElse(23)
    jmp @target_23

@target_5:

; snake_world.fth:133:3 in `move-snake-head`
...
; snake_world.fth:133:6 in `move-snake-head`
@OPCODE_15:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_6:

; snake_world.fth:133:14 in `move-snake-head`
@OPCODE_17:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_7:

; snake_world.fth:133:16 in `move-snake-head`
...
; snake_world.fth:133:19 in `move-snake-head`
@OPCODE_21:   ; [c64_ir] Call("move-up")
        jsr PAX_FN_move2Dup

@target_9:

; snake_world.fth:133:27 in `move-snake-head`
@OPCODE_23:   ; [c64_ir] JumpElse(22)
    jmp @target_22

@target_10:

; snake_world.fth:134:3 in `move-snake-head`
...
; snake_world.fth:134:9 in `move-snake-head`
@OPCODE_26:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_11:

; snake_world.fth:134:14 in `move-snake-head`
@OPCODE_28:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_12:

; snake_world.fth:134:16 in `move-snake-head`
...
; snake_world.fth:134:19 in `move-snake-head`
@OPCODE_32:   ; [c64_ir] Call("move-right")
        jsr PAX_FN_move2Dright

@target_14:

; snake_world.fth:134:30 in `move-snake-head`
@OPCODE_34:   ; [c64_ir] JumpElse(21)
    jmp @target_21

@target_15:

; snake_world.fth:135:3 in `move-snake-head`
...
; snake_world.fth:135:8 in `move-snake-head`
@OPCODE_37:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_16:

; snake_world.fth:135:14 in `move-snake-head`
@OPCODE_39:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_17:

; snake_world.fth:135:16 in `move-snake-head`
...
; snake_world.fth:135:19 in `move-snake-head`
@OPCODE_43:   ; [c64_ir] Call("move-down")
        jsr PAX_FN_move2Ddown

@target_19:

; snake_world.fth:136:3 in `move-snake-head`
@OPCODE_45:   ; [c64_ir] JumpTarget(19)

@target_20:

; snake_world.fth:136:8 in `move-snake-head`
@OPCODE_47:   ; [c64_ir] JumpTarget(20)

@target_21:

; snake_world.fth:136:13 in `move-snake-head`
@OPCODE_49:   ; [c64_ir] JumpTarget(21)

@target_22:

; snake_world.fth:136:18 in `move-snake-head`
@OPCODE_51:   ; [c64_ir] JumpTarget(22)

@target_23:

; snake_world.fth:136:23 in `move-snake-head`
@OPCODE_53:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:136:28 in `move-snake-head`
...
; snake_world.fth:140:3 in `move-snake-tail`
@OPCODE_1:   ; [c64_ir] PushLiteral(-1)
    inx
    inx
    lda #255
...
; snake_world.fth:140:6 in `move-snake-tail`
@OPCODE_2:   ; [c64_ir] PushLiteral(-26658)
    inx
    inx
    lda #222
...
; snake_world.fth:140:13 in `move-snake-tail`
...
; snake_world.fth:140:15 in `move-snake-tail`
@OPCODE_4:   ; [c64_ir] AltPush
    dex
    dex
    lda $03,x
...
; snake_world.fth:141:7 in `move-snake-tail`
@OPCODE_8:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_2:

; snake_world.fth:141:9 in `move-snake-tail`
@OPCODE_10:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:141:14 in `move-snake-tail`
@OPCODE_11:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_3:

; snake_world.fth:141:16 in `move-snake-tail`
@OPCODE_13:   ; [c64_ir] Call("snake-x")
        jsr PAX_FN_snake2Dx

@target_4:

; snake_world.fth:141:24 in `move-snake-tail`
...
; snake_world.fth:141:26 in `move-snake-tail`
@OPCODE_16:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_5:

; snake_world.fth:141:28 in `move-snake-tail`
...
; snake_world.fth:141:30 in `move-snake-tail`
@OPCODE_19:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:141:32 in `move-snake-tail`
@OPCODE_20:   ; [c64_ir] Call("snake-x")
        jsr PAX_FN_snake2Dx

@target_6:

; snake_world.fth:141:40 in `move-snake-tail`
@OPCODE_22:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:142:7 in `move-snake-tail`
@OPCODE_23:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_7:

; snake_world.fth:142:9 in `move-snake-tail`
@OPCODE_25:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_8:

; snake_world.fth:142:17 in `move-snake-tail`
...
; snake_world.fth:142:19 in `move-snake-tail`
@OPCODE_28:   ; [c64_ir] Call("i")
        jsr PAX_FN_i

@target_9:

; snake_world.fth:142:21 in `move-snake-tail`
...
; snake_world.fth:142:23 in `move-snake-tail`
@OPCODE_31:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:142:25 in `move-snake-tail`
@OPCODE_32:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_10:

; snake_world.fth:142:33 in `move-snake-tail`
...
; snake_world.fth:143:3 in `move-snake-tail`
...
; snake_world.fth:143:5 in `move-snake-tail`
...
; snake_world.fth:144:3 in `move-snake-tail`
...
; snake_world.fth:146:18 in `is-horizontal`
@OPCODE_1:   ; [c64_ir] PushLiteral(-26660)
    inx
    inx
    lda #220
...
; snake_world.fth:146:28 in `is-horizontal`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:146:30 in `is-horizontal`
@OPCODE_3:   ; [c64_ir] Call("dup")
        jsr PAX_FN_dup

@target_1:

; snake_world.fth:147:3 in `is-horizontal`
...
; snake_world.fth:147:8 in `is-horizontal`
@OPCODE_6:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:147:10 in `is-horizontal`
@OPCODE_8:   ; [c64_ir] Call("swap")
        jsr PAX_FN_swap

@target_3:

; snake_world.fth:148:3 in `is-horizontal`
...
; snake_world.fth:148:9 in `is-horizontal`
@OPCODE_11:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_4:

; snake_world.fth:148:11 in `is-horizontal`
@OPCODE_13:   ; [c64_ir] Call("or")
        jsr PAX_FN_or

@target_5:

; snake_world.fth:148:14 in `is-horizontal`
@OPCODE_15:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:150:16 in `is-vertical`
@OPCODE_1:   ; [c64_ir] PushLiteral(-26660)
    inx
    inx
    lda #220
...
; snake_world.fth:150:26 in `is-vertical`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:150:28 in `is-vertical`
@OPCODE_3:   ; [c64_ir] Call("dup")
        jsr PAX_FN_dup

@target_1:

; snake_world.fth:151:3 in `is-vertical`
...
; snake_world.fth:151:6 in `is-vertical`
@OPCODE_6:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:151:8 in `is-vertical`
@OPCODE_8:   ; [c64_ir] Call("swap")
        jsr PAX_FN_swap

@target_3:

; snake_world.fth:152:3 in `is-vertical`
...
; snake_world.fth:152:8 in `is-vertical`
@OPCODE_11:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_4:

; snake_world.fth:152:10 in `is-vertical`
@OPCODE_13:   ; [c64_ir] Call("or")
        jsr PAX_FN_or

@target_5:

; snake_world.fth:152:13 in `is-vertical`
@OPCODE_15:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:154:15 in `turn-up`
@OPCODE_1:   ; [c64_ir] Call("is-horizontal")
        jsr PAX_FN_is2Dhorizontal

@target_1:

; snake_world.fth:154:29 in `turn-up`
...
; snake_world.fth:154:32 in `turn-up`
@OPCODE_5:   ; [c64_ir] PushLiteral(38)
    inx
    inx
    lda #38
...
; snake_world.fth:154:35 in `turn-up`
...
; snake_world.fth:154:45 in `turn-up`
@OPCODE_7:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:154:47 in `turn-up`
@OPCODE_8:   ; [c64_ir] JumpTarget(2)

@target_3:

; snake_world.fth:154:52 in `turn-up`
@OPCODE_10:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:155:15 in `turn-left`
@OPCODE_1:   ; [c64_ir] Call("is-vertical")
        jsr PAX_FN_is2Dvertical

@target_1:

; snake_world.fth:155:27 in `turn-left`
@OPCODE_3:   ; [c64_ir] JumpIf0(3)
    dex
    dex
    lda $02,x
...
; snake_world.fth:155:30 in `turn-left`
@OPCODE_5:   ; [c64_ir] PushLiteral(37)
    inx
    inx
    lda #37
...
; snake_world.fth:155:35 in `turn-left`
@OPCODE_6:   ; [c64_ir] PushLiteral(-26660)
    inx
    inx
    lda #220
...
; snake_world.fth:155:45 in `turn-left`
@OPCODE_7:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:155:47 in `turn-left`
@OPCODE_8:   ; [c64_ir] JumpTarget(2)

@target_3:

; snake_world.fth:155:52 in `turn-left`
@OPCODE_10:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:156:15 in `turn-down`
@OPCODE_1:   ; [c64_ir] Call("is-horizontal")
        jsr PAX_FN_is2Dhorizontal

@target_1:

; snake_world.fth:156:29 in `turn-down`
@OPCODE_3:   ; [c64_ir] JumpIf0(3)
    dex
    dex
    lda $02,x
...
; snake_world.fth:156:32 in `turn-down`
...
; snake_world.fth:156:37 in `turn-down`
@OPCODE_6:   ; [c64_ir] PushLiteral(-26660)
    inx
    inx
    lda #220
...
; snake_world.fth:156:47 in `turn-down`
@OPCODE_7:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:156:49 in `turn-down`
@OPCODE_8:   ; [c64_ir] JumpTarget(2)

@target_3:

; snake_world.fth:156:54 in `turn-down`
@OPCODE_10:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:157:15 in `turn-right`
@OPCODE_1:   ; [c64_ir] Call("is-vertical")
        jsr PAX_FN_is2Dvertical

@target_1:

; snake_world.fth:157:27 in `turn-right`
@OPCODE_3:   ; [c64_ir] JumpIf0(3)
    dex
    dex
    lda $02,x
...
; snake_world.fth:157:30 in `turn-right`
...
; snake_world.fth:157:36 in `turn-right`
@OPCODE_6:   ; [c64_ir] PushLiteral(-26660)
    inx
    inx
    lda #220
...
; snake_world.fth:157:46 in `turn-right`
@OPCODE_7:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:157:48 in `turn-right`
@OPCODE_8:   ; [c64_ir] JumpTarget(2)

@target_3:

; snake_world.fth:157:53 in `turn-right`
@OPCODE_10:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:160:3 in `change-direction`
...
; snake_world.fth:160:8 in `change-direction`
@OPCODE_2:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_1:

; snake_world.fth:160:13 in `change-direction`
@OPCODE_4:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:160:15 in `change-direction`
...
; snake_world.fth:160:18 in `change-direction`
@OPCODE_8:   ; [c64_ir] Call("turn-left")
        jsr PAX_FN_turn2Dleft

@target_4:

; snake_world.fth:160:28 in `change-direction`
@OPCODE_10:   ; [c64_ir] JumpElse(23)
    jmp @target_23

@target_5:

; snake_world.fth:161:3 in `change-direction`
...
; snake_world.fth:161:6 in `change-direction`
@OPCODE_13:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_6:

; snake_world.fth:161:11 in `change-direction`
@OPCODE_15:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_7:

; snake_world.fth:161:13 in `change-direction`
...
; snake_world.fth:161:16 in `change-direction`
@OPCODE_19:   ; [c64_ir] Call("turn-up")
        jsr PAX_FN_turn2Dup

@target_9:

; snake_world.fth:161:24 in `change-direction`
@OPCODE_21:   ; [c64_ir] JumpElse(22)
    jmp @target_22

@target_10:

; snake_world.fth:162:3 in `change-direction`
...
; snake_world.fth:162:9 in `change-direction`
@OPCODE_24:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_11:

; snake_world.fth:162:14 in `change-direction`
@OPCODE_26:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_12:

; snake_world.fth:162:16 in `change-direction`
...
; snake_world.fth:162:19 in `change-direction`
@OPCODE_30:   ; [c64_ir] Call("turn-right")
        jsr PAX_FN_turn2Dright

@target_14:

; snake_world.fth:162:30 in `change-direction`
@OPCODE_32:   ; [c64_ir] JumpElse(21)
    jmp @target_21

@target_15:

; snake_world.fth:163:3 in `change-direction`
...
; snake_world.fth:163:8 in `change-direction`
@OPCODE_35:   ; [c64_ir] Call("over")
        jsr PAX_FN_over

@target_16:

; snake_world.fth:163:13 in `change-direction`
@OPCODE_37:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_17:

; snake_world.fth:163:15 in `change-direction`
...
; snake_world.fth:163:18 in `change-direction`
@OPCODE_41:   ; [c64_ir] Call("turn-down")
        jsr PAX_FN_turn2Ddown

@target_19:

; snake_world.fth:164:3 in `change-direction`
@OPCODE_43:   ; [c64_ir] JumpTarget(19)

@target_20:

; snake_world.fth:164:8 in `change-direction`
@OPCODE_45:   ; [c64_ir] JumpTarget(20)

@target_21:

; snake_world.fth:164:13 in `change-direction`
@OPCODE_47:   ; [c64_ir] JumpTarget(21)

@target_22:

; snake_world.fth:164:18 in `change-direction`
@OPCODE_49:   ; [c64_ir] JumpTarget(22)

@target_23:

; snake_world.fth:164:23 in `change-direction`
@OPCODE_51:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:164:28 in `change-direction`
...
; snake_world.fth:167:3 in `check-input`
...
; snake_world.fth:167:12 in `check-input`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:167:14 in `check-input`
@OPCODE_3:   ; [c64_ir] Call("change-direction")
        jsr PAX_FN_change2Ddirection

@target_1:

; snake_world.fth:168:3 in `check-input`
...
; snake_world.fth:168:5 in `check-input`
...
; snake_world.fth:168:14 in `check-input`
@OPCODE_7:   ; [c64_ir] Store
    dex
    dex
    dex
...
; snake_world.fth:168:16 in `check-input`
@OPCODE_8:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:172:3 in `random-x-position`
@OPCODE_1:   ; [c64_ir] PushLiteral(40)
    inx
    inx
    lda #40
...
; snake_world.fth:172:9 in `random-x-position`
...
; snake_world.fth:172:11 in `random-x-position`
@OPCODE_3:   ; [c64_ir] Call("-")
    ; http://www.obelisk.me.uk/6502/algorithms.html
    dex
    dex
...
; snake_world.fth:172:13 in `random-x-position`
@OPCODE_5:   ; [c64_ir] Call("random")
        jsr PAX_FN_random

@target_2:

; snake_world.fth:172:20 in `random-x-position`
...
; snake_world.fth:172:22 in `random-x-position`
@OPCODE_8:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:172:24 in `random-x-position`
@OPCODE_9:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:174:3 in `random-y-position`
...
; snake_world.fth:174:10 in `random-y-position`
@OPCODE_2:   ; [c64_ir] PushLiteral(4)
    inx
    inx
    lda #4
...
; snake_world.fth:174:12 in `random-y-position`
@OPCODE_3:   ; [c64_ir] Call("-")
    ; http://www.obelisk.me.uk/6502/algorithms.html
    dex
    dex
...
; snake_world.fth:174:14 in `random-y-position`
@OPCODE_5:   ; [c64_ir] Call("random")
        jsr PAX_FN_random

@target_2:

; snake_world.fth:174:21 in `random-y-position`
@OPCODE_7:   ; [c64_ir] PushLiteral(2)
    inx
    inx
    lda #2
...
; snake_world.fth:174:23 in `random-y-position`
@OPCODE_8:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:174:25 in `random-y-position`
@OPCODE_9:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:177:3 in `move-apple`
@OPCODE_1:   ; [c64_ir] PushLiteral(-26664)
    inx
    inx
    lda #216
...
; snake_world.fth:177:11 in `move-apple`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:177:13 in `move-apple`
@OPCODE_3:   ; [c64_ir] PushLiteral(-26662)
    inx
    inx
    lda #218
...
; snake_world.fth:177:21 in `move-apple`
@OPCODE_4:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:181:15 in `grow-snake`
@OPCODE_1:   ; [c64_ir] PushLiteral(1)
    inx
    inx
    lda #1
...
; snake_world.fth:181:17 in `grow-snake`
@OPCODE_2:   ; [c64_ir] PushLiteral(-26658)
    inx
    inx
    lda #222
...
; snake_world.fth:181:24 in `grow-snake`
@OPCODE_3:   ; [c64_ir] Call("+!")
        jsr PAX_FN_2B21

@target_1:

; snake_world.fth:181:27 in `grow-snake`
@OPCODE_5:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:184:3 in `check-apple`
...
; snake_world.fth:184:16 in `check-apple`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:184:18 in `check-apple`
...
; snake_world.fth:184:26 in `check-apple`
@OPCODE_4:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:184:28 in `check-apple`
@OPCODE_5:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_1:

; snake_world.fth:185:3 in `check-apple`
...
; snake_world.fth:185:16 in `check-apple`
...
; snake_world.fth:185:18 in `check-apple`
...
; snake_world.fth:185:26 in `check-apple`
...
; snake_world.fth:185:28 in `check-apple`
@OPCODE_11:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:186:3 in `check-apple`
@OPCODE_13:   ; [c64_ir] Call("and")
        jsr PAX_FN_and

@target_3:

; snake_world.fth:186:7 in `check-apple`
...
; snake_world.fth:187:5 in `check-apple`
@OPCODE_17:   ; [c64_ir] Call("move-apple")
        jsr PAX_FN_move2Dapple

@target_5:

; snake_world.fth:188:5 in `check-apple`
@OPCODE_19:   ; [c64_ir] Call("grow-snake")
        jsr PAX_FN_grow2Dsnake

@target_6:

; snake_world.fth:189:3 in `check-apple`
@OPCODE_21:   ; [c64_ir] JumpTarget(6)

@target_7:

; snake_world.fth:189:8 in `check-apple`
...
; snake_world.fth:193:3 in `check-collision`
@OPCODE_1:   ; [c64_ir] PushLiteral(-28668)
    inx
    inx
    lda #4
...
; snake_world.fth:193:16 in `check-collision`
@OPCODE_2:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:193:18 in `check-collision`
@OPCODE_3:   ; [c64_ir] PushLiteral(-27666)
    inx
    inx
    lda #238
...
; snake_world.fth:193:31 in `check-collision`
@OPCODE_4:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:196:3 in `check-collision`
@OPCODE_5:   ; [c64_ir] Call("convert-x-y")
        jsr PAX_FN_convert2Dx2Dy

@target_1:

; snake_world.fth:196:15 in `check-collision`
...
; snake_world.fth:196:24 in `check-collision`
@OPCODE_8:   ; [c64_ir] Add
    ; 21
    dex
    dex
...
; snake_world.fth:196:26 in `check-collision`
...
; snake_world.fth:199:3 in `check-collision`
...
; snake_world.fth:199:15 in `check-collision`
@OPCODE_11:   ; [c64_ir] Call("=")
        jsr PAX_FN_3D

@target_2:

; snake_world.fth:199:17 in `check-collision`
@OPCODE_13:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:202:3 in `draw-snake-head-tail`
@OPCODE_1:   ; [c64_ir] PushLiteral(0)
    inx
    inx
    lda #0
...
; snake_world.fth:202:13 in `draw-snake-head-tail`
@OPCODE_4:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:202:15 in `draw-snake-head-tail`
@OPCODE_5:   ; [c64_ir] PushLiteral(0)
    inx
    inx
    lda #0
...
; snake_world.fth:202:17 in `draw-snake-head-tail`
@OPCODE_6:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_2:

; snake_world.fth:202:25 in `draw-snake-head-tail`
@OPCODE_8:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:202:27 in `draw-snake-head-tail`
@OPCODE_9:   ; [c64_ir] Call("draw-snake-tile")
        jsr PAX_FN_draw2Dsnake2Dtile

@target_3:

; snake_world.fth:203:3 in `draw-snake-head-tail`
...
; snake_world.fth:203:10 in `draw-snake-head-tail`
@OPCODE_12:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:203:12 in `draw-snake-head-tail`
@OPCODE_13:   ; [c64_ir] Call("snake-x")
        jsr PAX_FN_snake2Dx

@target_4:

; snake_world.fth:203:20 in `draw-snake-head-tail`
@OPCODE_15:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:204:3 in `draw-snake-head-tail`
...
; snake_world.fth:204:10 in `draw-snake-head-tail`
@OPCODE_17:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:204:12 in `draw-snake-head-tail`
@OPCODE_18:   ; [c64_ir] Call("snake-y")
        jsr PAX_FN_snake2Dy

@target_5:

; snake_world.fth:204:20 in `draw-snake-head-tail`
...
; snake_world.fth:205:3 in `draw-snake-head-tail`
@OPCODE_21:   ; [c64_ir] Call("draw-white")
        jsr PAX_FN_draw2Dwhite

@target_6:

; snake_world.fth:205:14 in `draw-snake-head-tail`
@OPCODE_23:   ; [c64_ir] Exit
    rts
.endproc
...
; snake_world.fth:23:5 in `main`
@OPCODE_2:   ; [c64_ir] Call("cells")
        jsr PAX_FN_cells

@target_1:

; snake_world.fth:23:11 in `main`
@OPCODE_4:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:26:1 in `main`
...
; snake_world.fth:26:5 in `main`
@OPCODE_6:   ; [c64_ir] Call("cells")
        jsr PAX_FN_cells

@target_2:

; snake_world.fth:26:11 in `main`
@OPCODE_8:   ; [c64_ir] Drop
    dex
    dex

; snake_world.fth:212:1 in `main`
...
; snake_world.fth:212:13 in `main`
@OPCODE_10:   ; [c64_ir] Load
    lda ($00,x)
    sta $00,x
    lda #0
...
; snake_world.fth:212:15 in `main`
@OPCODE_11:   ; [c64_ir] Call("0=")
        jsr PAX_FN_03D

@target_3:

; snake_world.fth:212:18 in `main`
...
; snake_world.fth:212:21 in `main`
@OPCODE_15:   ; [c64_ir] Call("initialize")
        jsr PAX_FN_initialize

@target_5:

; snake_world.fth:212:32 in `main`
@OPCODE_17:   ; [c64_ir] JumpTarget(5)

@target_6:

; snake_world.fth:213:1 in `main`
...
; snake_world.fth:213:15 in `main`
...
; snake_world.fth:224:4 in `main`
@OPCODE_38:   ; [c64_ir] JumpElse(16)
    jmp @target_16

@target_15:

; snake_world.fth:224:9 in `main`
...
; snake_world.fth:224:11 in `main`
...
; snake_world.fth:224:23 in `main`
...
; snake_world.fth:224:25 in `main`
